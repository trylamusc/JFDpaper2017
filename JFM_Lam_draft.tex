...
The decrease in the fluttering amplitude in stratified flow can be observed in figure \ref{fig:amplitude}, where $a$ is the radial length of the flutter arc as seen from the top of the tank. The mean linear data fit of the individual descent cases are also plotted, where the average fluttering arc is relatively constant for descents in water $\left( a/d =-0.175~z/h\right)$ and decreasing for the mean stratified cases $\left( a/d =-1.483~z/h\right)$.
